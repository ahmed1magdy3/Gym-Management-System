        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("GymUserEgyptianPhone", "Phone like '[0][1][0125][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]' and len(phone) = 11");
                    table.CheckConstraint("GymUserEmailConstraint", "Email like '%_@__%.__%' ");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("GymUserEgyptianPhone1", "Phone like '[0][1][0125][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]' and len(phone) = 11");
                    table.CheckConstraint("GymUserEmailConstraint1", "Email like '%_@__%.__%' ");
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 4, "Boking", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null },
